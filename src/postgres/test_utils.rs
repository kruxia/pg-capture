...
pub mod scenarios {
    ...
    pub fn user_table_transaction() -> (MockMessageBuilder, Vec<Bytes>) {
        let builder = MockMessageBuilder::new().add_relation(
            1,
            "public",
            "users",
            vec![
        ...
        let messages = vec![
            ...
            builder.insert_message(
                ...
                vec![
                    ...
                    (
                        "data",
                        Some(r#"{"type": "product", "category": "electronics"}"#),
                    ),
