#[cfg(test)]
mod tests {
    use crate::postgres::decoder::{parse_postgres_binary_value, parse_postgres_value};
    ...
    fn test_bool_parsing() {
        ...
        assert_eq!(
            parse_postgres_value("invalid", 16),
    ...
    fn test_integer_parsing() {
        ...
        assert_eq!(
            parse_postgres_value("invalid", 21),
            Value::String("invalid".to_string())
        );

        // int4
        assert_eq!(
            parse_postgres_value("456789", 23),
            Value::Number(456789.into())
        );

        // int8
        assert_eq!(
            parse_postgres_value("9876543210", 20),
            Value::Number(9876543210i64.into())
        );
    }
    ...
    fn test_string_types() {
        // text
        assert_eq!(
            parse_postgres_value("Hello, World!", 25),
            Value::String("Hello, World!".to_string())
        );

        // varchar
        assert_eq!(
            parse_postgres_value("Variable length", 1043),
            Value::String("Variable length".to_string())
        );

        // char
        assert_eq!(
            parse_postgres_value("A", 18),
    ...
    fn test_datetime_types() {
        // timestamp
        assert_eq!(
            parse_postgres_value("2023-10-15 10:30:00", 1114),
            Value::String("2023-10-15 10:30:00".to_string())
        );

        // timestamptz
        assert_eq!(
            parse_postgres_value("2023-10-15 10:30:00+00", 1184),
            Value::String("2023-10-15 10:30:00+00".to_string())
        );

        // date
        assert_eq!(
            parse_postgres_value("2023-10-15", 1082),
    ...
    fn test_json_types() {
        ...
        assert_eq!(
            parse_postgres_value(invalid_json, 114),
    ...
    fn test_uuid_parsing() {
        ...
        assert_eq!(
            parse_postgres_value(uuid, 2950),
    ...
    fn test_numeric_parsing() {
        ...
        assert_eq!(
            parse_postgres_value("123.456789", 1700),
    ...
    fn test_unknown_type() {
        ...
        assert_eq!(
            parse_postgres_value("some value", 9999),
    ...
    fn test_binary_int_parsing() {
        ...
        assert_eq!(
            parse_postgres_binary_value(&bytes, 21),
        ...
        assert_eq!(
            parse_postgres_binary_value(&bytes, 23),
            Value::Number(456789.into())
        );
        ...
        assert_eq!(
            parse_postgres_binary_value(&bytes, 20),
            Value::Number(9876543210i64.into())
        );
    }
